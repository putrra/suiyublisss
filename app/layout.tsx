...
// Load Poppins font with weights used in page.tsx
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* Font Awesome CDN as used in page.tsx */}
        <link
          href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"
          rel="stylesheet"
        />
        {/* Poppins Google Fonts CDN as used in page.tsx */}
        <link
      ...
      >
        <main>{children}</main>
        {/* Footer styled to match page.tsx */}
